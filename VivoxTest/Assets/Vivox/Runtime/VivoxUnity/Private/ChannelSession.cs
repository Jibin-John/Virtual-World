    ...
    internal class ChannelSession : IChannelSession
    {
        ...
        private void HandleSessionTranscribedMessage(vx_evt_base_t eventMessage)
        {
            ...
            TranscribedMessage message = new TranscribedMessage(
                p != null ? p.Account : new AccountId(evt.participant_uri),
                evt.text,
        ...
        // DEPRECATED: Use the overload with bool instead of TransmitPolicy as the switchTransmission argument; this version will be removed in a future release.
        public IAsyncResult BeginConnect(bool connectAudio, bool connectText, TransmitPolicy switchTransmission,
            string accessToken, AsyncCallback callback)
        {
            return BeginConnect(connectAudio, connectText, switchTransmission == TransmitPolicy.Yes, accessToken, callback);
        }
        ...
        // DEPRECATED: Use the overload with bool instead of TransmitPolicy as the switchTransmission argument; this version will be removed in a future release.
        public IAsyncResult BeginSetAudioConnected(bool value, TransmitPolicy switchTransmission, AsyncCallback callback)
        {
            return BeginSetAudioConnected(value, switchTransmission == TransmitPolicy.Yes, callback);
        }
        ...
        // DEPRECATED: Use IsTransmitting() instead; this will be removed in a future release.
        public bool IsTransmittingSession
        {
            get
            {
                return _audioState != ConnectionState.Disconnected && this.Channel.Equals(_loginSession.TransmittingChannel);
            }
            set
            {
                if (value == false)
                {
                    if (!Channel.Equals(_loginSession.TransmittingChannel))
                        return;
        ...
        /// <summary>
        /// <see cref="ILoginSession "/> now handles transmission management so this method has been moved to ILoginSession.
        /// </summary>
        [Obsolete("DEPRECATED: This will be removed in a future release.")]
        private void SetTransmitting()
        {
            ...
            _loginSession.TransmittingChannel = Channel;
            VxClient.Instance.BeginIssueRequest(request, result =>
            {
                try
                {
        ...
        private void SetNoSessionTransmitting()
        {
            ...
            _loginSession.TransmittingChannel = null;
            VxClient.Instance.BeginIssueRequest(request, result =>
            {
                try
                {
