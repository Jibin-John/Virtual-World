...
namespace VivoxUnity
{
    ...
    public interface IChannelSession : IKeyedItemNotifyPropertyChanged<ChannelId>
    {
        ...
        /// </summary>
        /// <remarks>Setting this value to true will clear this value from all other sessions.</remarks>
        [Obsolete("DEPRECATED: Use IsTransmitting() instead; this will be removed in a future release.")]
        ...
        /// Developer of games that do not have secure communications requirements can use <see cref="GetConnectToken" /> to generate the required access token.
        /// </remarks>
        [Obsolete("DEPRECATED: Use the overload with bool instead of TransmitPolicy as the switchTransmission argument; this version will be removed in a future release.")]
        IAsyncResult BeginConnect(bool connectAudio, bool connectText, TransmitPolicy switchTransmission, string accessToken, AsyncCallback callback);
        ...
        /// <returns>The AsyncResult.</returns>
        [Obsolete("DEPRECATED: Use the overload with bool instead of TransmitPolicy as the switchTransmission argument; this version will be removed in a future release.")]
        IAsyncResult BeginSetAudioConnected(bool value, TransmitPolicy switchTransmission, AsyncCallback callback);
